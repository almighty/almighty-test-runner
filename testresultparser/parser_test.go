...
var path = "/home/hemani/workspace/src/github.com/almighty-test-runner/testresultparser/artifacts/"

func TestParseXML_Test1(t *testing.T) {
	actualResult, _ := Parse(path+"junit_failure_test.xml", "surefire")
	...
	assert.Equal(t, actualResult, expectedResult, "this is expected result")
}

func TestParseXML_Test2(t *testing.T) {
	actualResult, _ := Parse(path+"testNG_failure_test.xml", "surefire")
...
func TestParseXML_Test3(t *testing.T) {
	actualResult, _ := Parse(path+"gradle_failure_test.xml", "default")
...
func TestParseFailsafeXML(t *testing.T) {
	actualResult, _ := Parse(path+"failsafe-summary.xml", "failsafe")
...
func TestParseTxt(t *testing.T) {
	actualResult, _ := Parse(path+"testNG_failure_test.txt", "surefire")
	...
	assert.Equal(t, actualResult, expectedResult, "this is the expected result")
}
